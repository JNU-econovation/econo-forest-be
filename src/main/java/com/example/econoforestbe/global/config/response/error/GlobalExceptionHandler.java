...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(MethodArgumentTypeMismatchException e) {
        ...
        ErrorResponse errorResponse = ErrorResponse.of(HttpStatus.BAD_REQUEST.toString(),
                String.valueOf(MethodArgumentTypeMismatchException.class),
                e.getMessage());
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(errorResponse);
    }
    ...
    protected ResponseEntity<ErrorResponse> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException e) {
        ...
        ErrorResponse errorResponse = ErrorResponse.of(HttpStatus.METHOD_NOT_ALLOWED.toString(),
                String.valueOf(HttpRequestMethodNotSupportedException.class),
                e.getMessage());
    ...
    protected ResponseEntity<ErrorResponse> handleConflict(BusinessException e) {
        ...
        ErrorResponse errorResponse = ErrorResponse.of(e.getErrorCode().getErrorCode(),
                String.valueOf(BusinessException.class),
                e.getMessage());
    ...
    protected ResponseEntity<ErrorResponse> handleException(Exception e) {
        ...
        ErrorResponse errorResponse = ErrorResponse.of(HttpStatus.INTERNAL_SERVER_ERROR.toString(),
                String.valueOf(Exception.class),
                e.getMessage());
